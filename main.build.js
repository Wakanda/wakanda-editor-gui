...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editor = _interopRequire(__webpack_require__(1));

	var Toolbar = _interopRequire(__webpack_require__(2));

	var Tree = _interopRequire(__webpack_require__(3));

	var FileManager = _interopRequire(__webpack_require__(4));

	var PluginsManager = _interopRequire(__webpack_require__(5));

	var TabManager = _interopRequire(__webpack_require__(6));

	var _scriptsUtils = __webpack_require__(7);

	var query = _scriptsUtils.query;
	var mapExtToEditorMode = _scriptsUtils.mapExtToEditorMode;
	...
	/*
	 * Create Toolbar
	 * TMP : manually generate toolbar items list
	 */
	...
	switch (mode) {
		...
		default:
			!/* require.ensure */(function (require) {
				...
				IDE.editor = new Editor({ id: "editor", lib: ace, mode: mode });
			}(__webpack_require__));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var safeClassReplace = __webpack_require__(7).safeClassReplace;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tree = (function () {
		...
		_createClass(Tree, {
			render: {
				value: function render() {
					var jstree = __webpack_require__(17);
			...
			hookEvents: {
				value: function hookEvents() {
					...
					IDE.EventManager.on("tree.ready", function () {
						return _this.init();
					});
					var that = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Request = _interopRequire(__webpack_require__(22));
		...
		_createClass(PluginsManager, {
			...
			load: {
				value: function load(pluginName) {
					...
					this.plugins[pluginName].code = __webpack_require__(20)("./" + pluginName + "/index.js");
					this.plugins[pluginName].manifest = __webpack_require__(21)("./" + pluginName + "/manifest.js");
			...
			subscribePlugin: {
				value: function subscribePlugin(pluginName) {
					var _this = this;

					var subscriptions = this.plugins[pluginName].manifest.subscribe;

					subscriptions.forEach(function (event) {
						return _this.EventManager.on(event, _this.plugins[pluginName].code.on);
					});
				}
			},
			getToolbarElements: {
	...
	var tabManager = (function () {
	  ...
	  */
		function connect(name) {
			...
			_worker = new SharedWorker("/ce/scripts/shared-worker.js");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\styles\\common.css", function() {
			var newContent = require("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\styles\\common.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\styles\\editor.css", function() {
			var newContent = require("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\styles\\editor.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\styles\\tree.css", function() {
			var newContent = require("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\styles\\tree.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./chrome-remote-controle/index.js": 30,
		"./history/index.js": 32,
		"./save/index.js": 34
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./chrome-remote-controle/manifest.js": 31,
		"./history/manifest.js": 33,
		"./save/manifest.js": 35
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HttpClient = __webpack_require__(29).HttpClient;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HttpRequestMessage = __webpack_require__(49).HttpRequestMessage;
	exports.HttpResponseMessage = __webpack_require__(50).HttpResponseMessage;
	exports.JSONPRequestMessage = __webpack_require__(51).JSONPRequestMessage;
	exports.Headers = __webpack_require__(52).Headers;
	exports.RequestBuilder = __webpack_require__(53).RequestBuilder;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		save: function save() {
			...
			IDE.toolbar.addClassToItem("save", "save-disabled");
			...
			IDE.fileManager.setFile(IDE.qParams.path, IDE.editor.getContent()).then(function () {
				...
				IDE.toolbar.removeClassToItem("save", "save-disabled");
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Headers = __webpack_require__(52).Headers;

	var RequestBuilder = __webpack_require__(53).RequestBuilder;

	var _httpRequestMessage = __webpack_require__(49);
	...
	var _jsonpRequestMessage = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RequestMessageProcessor = __webpack_require__(60).RequestMessageProcessor;

	var _transformers = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var join = __webpack_require__(68).join;

	var HttpRequestMessage = __webpack_require__(49).HttpRequestMessage;

	var JSONPRequestMessage = __webpack_require__(51).JSONPRequestMessage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\plugins\\chrome-remote-controle\\style.css", function() {
			var newContent = require("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\plugins\\chrome-remote-controle\\style.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\plugins\\history\\style.css", function() {
			var newContent = require("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\plugins\\history\\style.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\plugins\\save\\style.css", function() {
			var newContent = require("!!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\node_modules\\css-loader\\index.js!c:\\Users\\Hamza\\Documents\\repositories\\CE\\StudioWeb\\WebFolder\\ce\\plugins\\save\\style.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HttpResponseMessage = __webpack_require__(50).HttpResponseMessage;

	var _aureliaPath = __webpack_require__(68);
