...
class Toolbar {
	// TODO: pluginsManager
	constructor({options, pluginsManager}) {
		...
		this._pluginsManager.onPluginActivated(this.addPluginItems);

		this._pluginsManager.onPluginsActivated(()=>this.create());
	...
	hookEvents(){
		this.container.addEventListener("click", function(event){
			...
			var plugin     = this._pluginsManager.get(pluginName);
	...
	create() {
		this.items = this._pluginsManager.getToolbarElements(); //TMP
		this.render();
		this.hookEvents();
	}
